...
public class HelloWorld {
    ...
    // The window handle
    private long window;
    private AlliesBoard alliesBoard = new AlliesBoard();
    private EnemiesBoard enemiesBoard = new EnemiesBoard();
    ...
    private void init() {
        ...
        // Create the window
        window = glfwCreateWindow(800, 600, "Card Game", NULL, NULL);
        if ( window == NULL )
